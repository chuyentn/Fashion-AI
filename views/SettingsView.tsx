...
export const SettingsView = ({ state, updateState, apiSettings, updateApiSettings, setShowVersionModal }: { state: AppState, updateState: (s: Partial<AppState>) => void, apiSettings: ApiSettings, updateApiSettings: (s: Partial<ApiSettings>) => void, setShowVersionModal: (v: boolean) => void }) => {
  ...
  return (
    <div className="flex-1 h-full overflow-y-auto bg-[#f7f6f8] dark:bg-[#110b18] animate-fadeIn relative">
      ...
      <div className="p-6 md:p-10 max-w-[1400px] mx-auto pb-32 text-left relative z-10 studio-container">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 items-start">
          ...
          <div className="space-y-8">
            ...
            {/* --- PROFILE SECTION --- */}
            <div className="card-premium rounded-[40px] p-8 md:p-10 animate-slideUp bg-white dark:bg-[#1a1025] border border-gray-200 dark:border-white/[0.08] shadow-sm dark:shadow-xl">
            ...
            {/* --- GEMINI API SECTION --- */}
            <div className="card-premium rounded-[32px] p-6 md:p-10 animate-slideUp bg-white dark:bg-[#1a1025] border border-gray-200 dark:border-white/[0.08] shadow-sm dark:shadow-xl" style={{ animationDelay: '0.1s' }}>
          ...
          <div className="space-y-8">
            ...
            {/* --- OPENAI API SECTION --- */}
            <div className="card-premium rounded-[32px] p-6 md:p-10 animate-slideUp bg-white dark:bg-[#1a1025] border border-gray-200 dark:border-white/[0.08] shadow-sm dark:shadow-xl" style={{ animationDelay: '0.25s' }}>
              <div className="flex items-center gap-5 mb-8">
            ...
            {/* --- DATA MANAGEMENT --- */}
            <div className="card-premium rounded-[32px] p-6 md:p-8 animate-slideUp bg-white dark:bg-[#1a1025] border border-gray-200 dark:border-white/[0.08] shadow-sm dark:shadow-xl" style={{ animationDelay: '0.3s' }}>
